...
const SliderItem = ({ link, src, alt, title, id = 0 }: ISliderItem) => (
  <li className={'keen-slider__slide number-slide' + id} key={alt}>
    <Link
      href={link}
      className='full flex h-[148px] transition w-full max-w-[120px] flex-col items-center justify-between rounded-2xl bg-white-dis px-5 py-[18px] hover:cursor-pointer hover:bg-light-grey'
    >
