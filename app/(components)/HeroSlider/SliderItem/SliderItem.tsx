...
const SliderItem = ({ src, alt, title, id = 0 }: ISliderItem) => (
  <li
    className={`keen-slider__slide number-slide${id} flex h-[148px] w-[120px] min-w-[120px] flex-col items-center justify-between rounded-2xl bg-white-dis px-5 py-[18px]`}
    key={alt}
  >
