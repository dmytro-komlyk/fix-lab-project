...
const SliderItem: React.FC<ISliderItem> = ({
  ...
  <li className={`keen-slider__slide number-slide${id}`} key={alt}>
    <Link
      href={link}
      className='flex h-[148px] w-full max-w-[120px] cursor-pointer flex-col items-center justify-between rounded-2xl bg-white-dis px-5 py-[18px] transition-colors hover:bg-light-grey focus:bg-light-grey'
    >
